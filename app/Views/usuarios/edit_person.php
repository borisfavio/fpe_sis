        ...
        <input type="text" name="local_id" value="<?php echo $beneficiario->local_id; ?>" required>
        <br>

        <label for="account_name">Nombre de la Cuenta:</label>
        <input type="text" name="account_name" value="<?php echo $beneficiario->account_name; ?>" required>
        <br>
